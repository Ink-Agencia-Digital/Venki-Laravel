<template>
    <div>
        <Panel ref="panelList" title="Tabla de notificaciones">
            <b-container>
                            ...
                            <span v-if="props.column.field == 'actions'">
                                <span>
                                    <div class="text-center">
                                        <a
                                            class="btn btn-grey"
                                            @click="selectNotificacion(props.row)"
                                        >
        ...
        confirmDelete(notificacion_id) {
            this.$swal({
                ...
                if (response.value) {
                    ...
                    this.$http({
                        method: "DELETE",
                        url: "/api/notifications/" + notificacion_id,
                    })
                        .then(() => {
                            this.$swal({
                                title: "Hecho!",
