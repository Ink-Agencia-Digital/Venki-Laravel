<template>
    <div>
        <Panel ref="panelList" title="Tabla de membresias">
            <b-container>
                            ...
                            <span v-if="props.column.field == 'actions'">
                                <span>
                                    <div class="text-center">
                                        <a
                                            class="btn btn-grey"
                                            @click="selectMembresia(props.row)"
                                        >
    ...
    methods: {
        confirmDelete(membresia_id) {
            this.$swal({
                ...
                if (response.value) {
                    ...
                    this.$http({
                        method: "DELETE",
                        url: "/api/membresias/" + membresia_id,
                    })
                        .then(() => {
                            this.$swal({
                                title: "Hecho!",
        ...
        loadMembresias() {
            ...
            this.$http({
                method: "GET",
                url:
                    "/api/membresias?per_page=" +
                    this.perPage +
                    "&page=" +
                    this.page,
            })
                .then((response) => {
                    this.membresias = response.data.data;
