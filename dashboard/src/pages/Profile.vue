...
export default {
    components: {
        CreateProfile: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/profiles/CreateProfile.vue"
            ).then((CreateProfile) => {
                resolve(CreateProfile.default);
            });
        },
        ListProfiles: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/profiles/ListProfiles.vue"
            ).then((ListProfiles) => {
