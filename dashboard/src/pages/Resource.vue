<template>
    <div>
        ...
        <h1 class="page-header">
            Recursos
            <small>Admnistracion de Recursos</small>
        </h1>
        <!-- end page-header -->
...
export default {
    components: {
        CreateResource: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/resources/CreateResource.vue"
            ).then((CreateResource) => {
                resolve(CreateResource.default);
            });
        },
        ListResources: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/resources/ListResources.vue"
            ).then((ListResources) => {
