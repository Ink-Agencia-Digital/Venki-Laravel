<template>
    <div>
        ...
        <h1 class="page-header">
            Resultados
            <small>Consultar Resultados</small>
        </h1>
        <!-- end page-header -->
        ...
        <b-container>
            <b-row>
                <b-col md="12">
                    <ListResultados ref="resultados-list" />
                </b-col>
            </b-row>
        </b-container>
    </div>
...
export default {
    components: {
        ListResultados: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/resultado/ListResultados.vue"
            ).then((ListResultados) => {
                resolve(ListResultados.default);
            });
        },
    },
    data() {
