...
export default {
    components: {
        ListReplies: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/replies/ListReplies.vue"
            ).then((ListReplies) => {
                resolve(ListReplies.default);
            });
        },
        ViewReply: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/replies/ViewReply.vue"
            ).then((ViewReply) => {
                resolve(ViewReply.default);
            });
        },
    },

    data() {
        return { selectedReply: null, viewKey: 0 };
    },
    methods: {
        selectReply(reply_id) {
            ...
            this.$http({
                ...
                .then((response) => {
                    this.selectedReply = response.data.data;
                    loader.hide();
                })
                .catch((error) => {
                    console.log(error);
