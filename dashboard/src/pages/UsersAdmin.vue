<template>
    <div>
        ...
        <h1 class="page-header">
            Administradores
            <small>Admnistración de usuarios administradores</small>
        </h1>
        <!-- end page-header -->
...
export default {
    ...
    components: {
        CreateUser: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/usersadmin/CreateUser.vue"
            ).then((CreateUser) => {
        ...
        ListUser: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/usersadmin/ListUser.vue"
                ).then((ListUser) => {
        ...
        UpdateUser: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/usersadmin/UpdateUser.vue"
            ).then((UpdateUser) => {
