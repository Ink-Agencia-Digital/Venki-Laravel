<template>
    <div>
        ...
        <h1 class="page-header">
            Encuestas
            <small>Admnistracion de Encuestas</small>
        </h1>
        <!-- end page-header -->
...
export default {
    components: {
        CreateSurvey: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/surveys/CreateSurvey.vue"
            ).then((CreateSurvey) => {
                resolve(CreateSurvey.default);
            });
        },
        ListSurveys: (resolve) => {
            import(
                /* webpackChunkName: "components" */ "@/components/surveys/ListSurveys.vue"
            ).then((ListSurveys) => {
                resolve(ListSurveys.default);
            });
        },
    },
    data() {
    ...
    methods: {
        ...
        registrationSuccessful() {
            this.resetRegister();
            this.$refs["surveys-list"].loadSurveys();
        },
        updateSuccess() {
            this.$refs["surveys-list"].loadSurveys();
        },
